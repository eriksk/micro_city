...
public class Noise {
    ...
    public static float[][] noise(int width, int height) {
    ...
    public static float[][] perlinNoise(float[][] baseNoise, int octaveCount) {
        int width = baseNoise.length;
        int height = baseNoise[0].length;
    ...
    public static float[][] perlinNoise(int width, int height, int octaveCount) {
        ...
        return perlinNoise(baseNoise, octaveCount);
    }
}
